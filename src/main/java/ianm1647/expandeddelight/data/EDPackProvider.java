...
public class EDPackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public EDPackProvider(PackOutput output, CompletableFuture<RegistrySetBuilder.PatchedRegistries> registries) {
        super(output, registries, Set.of(ExpandedDelight.MODID));
    }
