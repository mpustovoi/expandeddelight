...
public class EDWorldGen {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> FEATURE_SALT_ORE;
    ...
    static {
        FEATURE_SALT_ORE = ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(MODID, "salt_ore"));
